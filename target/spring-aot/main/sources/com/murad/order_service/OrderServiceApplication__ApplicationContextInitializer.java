 ...
 */
@Generated
public class OrderServiceApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new OrderServiceApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new OrderServiceApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
