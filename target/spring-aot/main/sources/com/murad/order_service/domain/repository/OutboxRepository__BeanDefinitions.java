...
/**
 * Bean definitions for {@link OutboxRepository}.
 */
@Generated
public class OutboxRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'outboxRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getOutboxRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'outboxRepository'.
   */
  public static BeanDefinition getOutboxRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, OutboxRepository.class, OutboxEvent.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.murad.order_service.domain.repository.OutboxRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.OutboxRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.murad.order_service.domain.repository.OutboxRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getOutboxRepositoryInstanceSupplier();
